<template>
  <div class="app-container">
    ...
    />
    <el-dialog v-model="dialogTableVisible" title="添加合同" width="600">
      <edit-table />
      <template #footer>
    ...
    <el-dialog v-model="dialogTableVisible2" title="关联设备" width="90%">
      <el-form :model="deviceParams" ref="queryRef" :inline="true">
        ...
        <el-form-item>
          <el-button type="primary" icon="Search" @click="deviceQuery"
            >搜索</el-button
          >
          <el-button icon="Refresh" @click="deviceRest">重置</el-button>
        </el-form-item>
      </el-form>
      <el-table :data="deviceTableData" style="width: 100%; height: 50vh">
